...
!function( $ ) {
    ...
    Nette.validators.dateRange = function(elem, arg, val) {
        ...
        try {
            min = DPGlobal.parseDate(arg[0].date.substr(0, 10), DPGlobal.parseFormat('yyyy-mm-dd hh:ii'), language);
        }catch(e){}
        try {
            max = DPGlobal.parseDate(arg[1].date.substr(0, 10), DPGlobal.parseFormat('yyyy-mm-dd hh:ii'), language);
        }catch(e){}
